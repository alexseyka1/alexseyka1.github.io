      ...
      <div className="container">
        ...
        >
          ...
          <li>
            ...
            />
            <p>
              I have been working for a long time on a mobile application that interacts with a hardware device, a smart
              inverter that collects information about the generation of electricity from solar panels. It was extremely
              interesting and difficult to understand the Modbus protocol and work with individual bytes of information.
              Especially when Bluetooth LE limited me in many ways. Unfortunately, funding for this project has run out.
            </p>
            <p>
              The new investor had his own development team and preferred that they continue developing the application.
              The problem was that they knew nothing about the hardware for which the application was made, nor about
              the existing application, nor about the technologies that were used in it. That&apos;s why I was hired as
              a consultant for this team (a consultant who also writes code).
            </p>
            <p>
              During 9 months of working in an international company, I gained a wealth of experience in communication,
              mentoring other developers, and also looked at React Native from a different perspective.
            </p>
          </li>
          ...
          <li>
            ...
            <p>
              ...
              projects are closed or frozen, but new ones appear.
            </p>
          </li>
        </ul>
      </div>
