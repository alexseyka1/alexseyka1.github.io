    ...
    <>
        ...
        <div className="container">
          <div className="row flex-md-row-reverse justify-content-center align-items-center g-5">
            <div
              ...
              style={{
                backgroundImage: "url(/img/projects/ssg/website.png)",
            ...
            <div className="col-md-6 col-lg-6">
              ...
              <h1 className="display-5 fw-bold lh-1">
                Australian solar service provider
              </h1>
              <p className="fs-5 text-muted mb-3">as Full Stack developer</p>
              <p className="lead py-2">
                Work on the internal system for managing the schedule of
                installations of solar systems. Long-term project.
              </p>
      ...
      <section id="timeline">
        <div className="container">
          ...
          <a
            href="/img/projects/ssg/admin-panel.png"
            target="_blank"
          ...
          <p>
            I got involved with this project back in 2017 and it has become the
            longest-running project in my remote job at Aussiedev. By the way,
            this was far from the beginning of this project, it had existed for
            several years. This is an Australian company specializing in the
            installation and repair of solar panels, batteries and everything
            related to them. Their website only has general information about
            the company, articles and a feedback form, so all my work was on the
            internal CRM system. Technologies already known to me were used
            here: PHP 5.6, MySQL, jQuery (it used to be everywhere) and the
            first version of the Yii framework.
          </p>
          <p>
            The admin panel that I saw here was significantly different from the
            one I saw in dok.ua. All functions were more intelligently located,
            and instead of pure SQL, which was widely used at my last job,
            ActiveRecord was used here. I liked it and learned it quickly. I`ve
            found that it`s quite handy if I use it correctly in conjunction
            with data providers, iterators and eager loading, otherwise
            everything will run slowly and eat up a lot of memory. I also saw
            for the first time on this project how to build separate
            applications on the same code base (api, backend, frontend,
            console).
          </p>
          <p>
            At the beginning of my work, from third-party services, only
            services for sending emails and SMS were used here. But over time, I
            had to connect more and more new third-party services that the
          ...
          <ul className="my-2">
            ...
            <li>
              Service FormBay, where potential customers filled out application
              forms for the installation of solar systems.
            </li>
            <li>
              Payment service Secure Pay, to pay for orders with a credit card.
            </li>
          </ul>
          <p>
            There were many such services and they all provided different types
            of APIs, these are REST and SOAP. I learned how to write adapters
            for such services so that my colleagues and I can quickly and easily
            connect new ones when needed.
          </p>
          <p>
            ...
            and what they cannot. Also, over time, subsidiaries appeared, which
            should not have been able to see each other`s orders. To do this, I
            made isolation of companies inside the system, as well as an
            extended system of roles and access rights. I also developed an API
            to synchronize data between our system and the systems of
            subsidiaries. Thanks to this, I have a better understanding of these
            issues.
          </p>
        </div>
      </section>
      ...
      <section>
        <div className="container">
          ...
          <p>
            ...
            the protocol, but it greatly simplified the work of the company`s
            employees, and also saved a lot of money for the business.
          </p>
          ...
          <p>
            Some of the company`s most important employees were solar installers
            and so-called &quot;field agents&quot; who communicated with
            potential customers, collecting information about their home and the
            equipment they needed. The admin panel on this project was quite
            cumbersome and not designed for mobile devices, and these employees
            needed to upload photos and write the collected information into our
            system. Of course, they were forced to do it from their smartphones
            or tablets.
          </p>
          <p>
          ...
          <p>
            It wasn`t the coolest app, and it wasn`t the hardest either. But it
            helped me to delve into the specifics of the work of employees and
            study it better in order to make tools even more convenient for
            them.
          </p>
        </div>
      </section>
