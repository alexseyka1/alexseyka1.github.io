    ...
    <>
        ...
        <div className="container">
          <div className="row flex-md-row-reverse justify-content-center align-items-center g-5">
            <div
              ...
              style={{
                backgroundImage: "url(/img/projects/dok/website.png)",
            ...
            <div className="col-md-6 col-lg-6">
              ...
              <h1 className="display-5 fw-bold lh-1 mb-0">
                Online auto parts store Dok.ua
              </h1>
              <p className="fs-5 text-muted mb-3">as Junior PHP developer</p>
              <p className="lead py-2">
                Mainly backend work, internal CRM system. Managing goods and
                suppliers, filling in the characteristics of goods and much
                more.
              </p>
      ...
      <section id="timeline">
        <div className="container">
          ...
          <a
            href="/img/projects/dok/parsing.jpg"
            target="_blank"
          ...
          <p>
            The first thing I had to deal with here was the parsers. The team
            and I needed to process a large amount of data - information about
            engine oils. It was descriptions of oils, characteristics and photos
            from manufacturers that needed to be systematized, which I did very
            well. It was solved using pure PHP and Javascript{" "}
            <a
          ...
          <p>
            ...
            frameworks have a lot in common, they both use the MVC data
            splitting pattern, which I find pretty handy and easy to understand.
          ...
          <p>
            Due to my little experience, almost all my tasks were related to the
            admin panel, where there was nothing urgent, and speed and
            ...
            myself. I also worked on the order view page and added new
            functionality there. That`s when I learned the &quot;state&quot;
            design pattern. I also had tasks related to setting up products and
            access rights for admin users.
          </p>
          <p>
            Later, when I gained some experience, I began to receive more
            complex and responsible tasks. I began to deal directly with the
            site of the online store, which was used by customers, not only the
            backend, but also the frontend. I added functionality to the product
            view page, improved the shopping cart, and also updated the buyer
            profile page. I connected third-party services, for example, a new
            version of the &quot;Nova Poshta&quot; mail service API.
          </p>
          <p>
            All site data was stored in a MySQL database, so I had to learn it
            too. Thanks to my team leader Nikolai Polimushket for helping me
            fall in love with SQL. He showed me how complex queries can be and
            how fast they can run if everything is set up correctly. After that,
            it was easier for me to learn PostgreSQL.
          </p>
        </div>
      </section>
      ...
      <section>
        <div className="container">
          ...
          <p>
            This company employs a lot of sales managers, and when a buyer
            places an order on the site, one of the managers accepts it, for
            which he then receives a bonus to his salary. Later there was a
            problem, sales managers began to take a lot of orders and leave them
            &quot;for later&quot; in order to get a big increase in salary. They
            even started using special clicker programs for this.
          </p>
          <p>
            I designed a fairly good solution and implemented it. I wrote a
            daemon that recorded the acceptance of orders by managers in a table
            in the database and put this manager in idle for a certain time. The
            script also sorted the managers in such a way that the new order was
            shown to the one who was out of work the longest. If this manager
            did not accept the order after a certain time, then this order will
            see the next one in order.
          </p>
          <p>
            Now if the manager has accepted one order, he will not see new
            ...
            that I could solve this problem in a completely different way, more
            correctly, using the queue system for this.
          </p>

          <a
            href="/img/projects/dok/content.png"
            target="_blank"
          ...
          <p>
            ...
            tools for them. These were sections in the admin panel for uploading
            product photos, editing product descriptions and adding
          ...
          <p>
            ...
            but also allowed them to monitor the progress of their work using a
            dashboard. The application worked with data through a simple REST
            API written as part of a common CRM system. After a while, I
            concluded that Angular is too cumbersome for small applications and
            Vue would be more suitable.
          </p>
        </div>
      </section>
