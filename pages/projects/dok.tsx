        ...
        <TextSection title="How it was?" className="border-none border-y">
          <div>
            ...
            <p>
              ...
              engine oils. It was descriptions of oils, characteristics and
              photos from manufacturers that needed to be systematized, which I
              did very well. It was solved using pure PHP and Javascript{" "}
              <a
            ...
            <p className="mt-4">
              ...
              splitting pattern, which I find pretty handy and easy to
            ...
            <p className="mt-4">
              ...
              product view page, improved the shopping cart, and also updated
              the buyer profile page. I connected third-party services, for
              example, a new version of the &quot;Nova Poshta&quot; mail service
              API.
            </p>
            ...
            <p className="mt-4">
              ...
              how fast they can run if everything is set up correctly. After
              that, it was easier for me to learn PostgreSQL.
            </p>
          </div>
        </TextSection>
